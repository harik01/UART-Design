...
HD_PWD='C:/Users/ADMIN/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_tb.tcl -notrace
